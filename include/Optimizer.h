...
int static PoseOptimization(Frame *pFrame, bool bStruct);
int static PoseOptimization_strict(Frame *pFrame);
...
int static TranslationOptimization(Frame* pFrame,bool bStruct);
};
